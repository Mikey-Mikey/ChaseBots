...
hook.Add("HUDPaint", "DrawRoundTime", function()
    ...
    draw.RoundedBoxEx(16, timerX - 100, timerY, 200, 72, Color(0,0,0,200), false, false, true, true)
    ...
    if radioVisualizerCVar:GetBool() and IsValid(radio_station) then
        ...
        for i = 2, #spectrum do
            ...
            -- Draw the bars
            draw.RoundedBox(0, xPos + math.floor(spectrumX) - borderThickness, spectrumY + barWidth - borderThickness, barWidth + borderThickness * 2, barHeights[i] + borderThickness * 2, Color(0, 0, 0))
